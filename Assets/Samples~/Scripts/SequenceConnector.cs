...
namespace Samples.Scripts
{
    ...
    /// This mono behaviour will persist between scenes and is accessed via SentienceConnector.Instance singleton.
    /// </summary>
    public class SentienceConnector : MonoBehaviour
    {
        public Chain Chain = Chain.TestnetArbitrumSepolia;
        public static SentienceConnector Instance { get; private set; }
