...
namespace Sentience.Relayer
{
    public class MintingRequestProver
    {
        ...
        public MintingRequestProver(Sentience.WaaS.IWallet waasWallet, Chain chain)
        {
            _chain = chain;
        ...
        {
            private Sentience.WaaS.IWallet _waasWallet;
            private Chain _chain;

            public WaaSProofSigner(Sentience.WaaS.IWallet waasWallet, Chain chain)
            {
