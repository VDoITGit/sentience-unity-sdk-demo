...
namespace Sentience.Authentication
{
    public class OpenIdAuthenticator
    {
        ...
        private static string RedirectUrl = "https://dev2-api.sentience.app/oauth/callback";
        ...
        private void SetClientIds(SentienceConfig config)
        {
#if UNITY_IOS
        ...
        public void GoogleSignIn()
        {
            try
            {
                ...
                {
                    throw SentienceConfig.MissingConfigError("Google Client Id");
                }
        ...
        public void DiscordSignIn()
        {
            try
            {
                ...
                {
                    throw SentienceConfig.MissingConfigError("Discord Client Id");
                }
        ...
        public void FacebookSignIn()
        {
            try
            {
                ...
                {
                    throw SentienceConfig.MissingConfigError("Facebook Client Id");
                }
        ...
        public void AppleSignIn()
        {
            try
            {
                ...
                {
                    throw SentienceConfig.MissingConfigError("Apple Client Id");
                }
        ...
        private string GenerateSignInUrl(string baseUrl, string clientId, string method)
        {
            ...
            {
                throw SentienceConfig.MissingConfigError("WaaS Project Id");
            }

            if (string.IsNullOrWhiteSpace(_urlScheme))
            {
                throw SentienceConfig.MissingConfigError("Url Scheme");
            }
        ...
        public void PlatformSpecificSetup()
        {
            ...
            string[] commands = new string[]{
                $"add HKEY_CURRENT_USER\\Software\\Classes\\{_urlScheme} /t REG_SZ /d \"URL:Sentience Login for {Application.productName}\" /f",
