...
and in that case, my mission will be complete.";
    ...
    private static object[] DecodeArrayTests =
    {
        ...
        new object[]
        {
            ...
            new Address[] { new Address(SentienceCoder.AddressChecksum("0x1099542D7dFaF6757527146C0aB9E70A967f71C0")) },
            "address[]"
        },
        new object[]
        {
            ...
            new Address[] { new Address(SentienceCoder.AddressChecksum("0xc683a014955b75F5ECF991d4502427c8fa1Aa249")), Address.ZeroAddress, },
            "address[2]"
        },
    };
