...
using ContractDeploymentResult = Sentience.Contracts.ContractDeploymentResult;
using IWallet = Sentience.Wallet.IWallet;
...
public class EthWalletTests
{
    ...
    public void EIP155SigningTxTest()
    {
        ...
        string sigining_hash = "0x" + SentienceCoder.KeccakHash(expected_signing_data);
        ...
        (string v, string r, string s) =
            wallet.SignTransaction(SentienceCoder.HexStringToByteArray(expected_signing_hash), "1");
    ...
    public async Task TestWalletSignMessageExistingPrefix()
    {
        ...
        CollectionAssert.AreEqual(SentienceCoder.HexStringToByteArray("b3c503217dbb0fae8950dadf73e2f500e968abddb95e22306ba95bbc7301cc01"), wallet.privKey.sec.ToBytes());

        string address = wallet.GetAddress();
        CollectionAssert.AreEqual("0x2AD3Df4A43445545e486a5c62F98Cee22d500bdf", address);

        byte[] _19 = SentienceCoder.HexStringToByteArray("19");
