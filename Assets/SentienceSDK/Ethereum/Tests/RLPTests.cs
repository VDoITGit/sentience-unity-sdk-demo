...
public class RLPTest
{
    ...
    public void RLPEncodingStandardTests()
    {
        ...
        Debug.Log(SentienceCoder.ByteArrayToHexString(dog_expected));
        Debug.Log(SentienceCoder.ByteArrayToHexString(dog_encoded));
        ...
        Debug.Log(SentienceCoder.ByteArrayToHexString(list_expected));
        Debug.Log(SentienceCoder.ByteArrayToHexString(list_encoded));
        ...
        Debug.Log(SentienceCoder.ByteArrayToHexString(helloworld_expected));
        Debug.Log(SentienceCoder.ByteArrayToHexString(helloworld_encoded));
        ...
        Debug.Log(SentienceCoder.ByteArrayToHexString(a_1024_expected));
        Debug.Log(SentienceCoder.ByteArrayToHexString(a_1024_encoded));
        ...
        Debug.Log(SentienceCoder.ByteArrayToHexString(longList_expected));
        Debug.Log(SentienceCoder.ByteArrayToHexString(longList_encoded));
    ...
    public void RLPEncodingEmptyTests()
    {
        ...
        Debug.Log(SentienceCoder.ByteArrayToHexString(empty_string_expected));
        Debug.Log(SentienceCoder.ByteArrayToHexString(empty_string_encoded));
        ...
        Debug.Log(SentienceCoder.ByteArrayToHexString(empty_list_expected));
        Debug.Log(SentienceCoder.ByteArrayToHexString(empty_list_encoded));
        ...
        Debug.Log(SentienceCoder.ByteArrayToHexString(three_expected));
        Debug.Log(SentienceCoder.ByteArrayToHexString(three_encoded));
    ...
    public void RLPEncodingIntegerTests()
    {
        ...
        byte[] integer_1_encoded = RLP.Encode(SentienceCoder.HexStringToByteArray(integer_1_str));
        Debug.Log(SentienceCoder.ByteArrayToHexString(integer_1_encoded));
