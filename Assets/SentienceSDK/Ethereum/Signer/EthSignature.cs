...
namespace Sentience.Signer
{
    public static class EthSignature
    {
        ...
        {
            byte[] sig = SentienceCoder.HexStringToByteArray(signature);
        ...
        {
            string r = SentienceCoder.ByteArrayToHexString(R);
            string s = SentienceCoder.ByteArrayToHexString(S);
        ...
        {
            return (V, "0x" + SentienceCoder.ByteArrayToHexString(R).TrimStart('0'), "0x"+ SentienceCoder.ByteArrayToHexString(S).TrimStart('0'));
        }
    }
