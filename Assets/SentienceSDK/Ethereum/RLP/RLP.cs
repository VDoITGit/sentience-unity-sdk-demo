    ...
    public class RLP
    {
        ...
        public static byte[] Encode(object input)
        {
            ...
            else if (input is byte[] byteArrayInput)
            {
                ...
                {
                    byte[] head = SentienceCoder.HexStringToByteArray((EncodeLength(byteArrayInput.Length, 128)));
            ...
            else if (input is List<object> listInput)
            {
                ...
                byte[] head = SentienceCoder.HexStringToByteArray(EncodeLength(output.Length, 192));
        ...
        private static (int, int, Type) DecodeLength(byte[] input)
        {
            ...
            else if (firstByte <= 191 && length > (firstByte - 183))
            {
                ...
                string hexString = SentienceCoder.ByteArrayToHexString(lenArray);
