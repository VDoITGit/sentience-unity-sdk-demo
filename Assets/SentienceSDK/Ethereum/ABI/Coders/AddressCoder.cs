...
namespace Sentience.ABI
{
    ...
    public class AddressCoder : ICoder
    {
        ...
        public object Decode(byte[] encoded)
        {
            try
            {
                string encodedString = SentienceCoder.ByteArrayToHexString(encoded);
                string decoded = SentienceCoder.AddressChecksum(DecodeFromString(encodedString));
                return decoded;
            }
            catch (Exception ex)
            {
    ...
    public static class AddressCoderExtensions
    {
        ...
        public static string Decode(string encodedString)
        {
            ...
            try
            {
                string decoded = SentienceCoder.AddressChecksum(_addressCoder.DecodeFromString(encodedString));
                return decoded;
            }
            catch (Exception ex)
            {
