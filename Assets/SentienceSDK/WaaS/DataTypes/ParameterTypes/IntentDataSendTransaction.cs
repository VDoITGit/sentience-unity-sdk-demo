...
namespace Sentience.WaaS
{
    ...
    public class IntentDataSendTransaction
    {
        ...
        public IntentDataSendTransaction(string walletAddress, string network, Sentience.WaaS.Transaction[] transactions)
        {
        ...
        public IntentDataSendTransaction(string walletAddress, Chain network, Sentience.WaaS.Transaction[] transactions)
        {
        ...
        public IntentDataSendTransaction(string code, uint expires, uint issued, string network, JObject[] transactions, string wallet)
        {
            ...
            this.transactions = new Sentience.WaaS.Transaction[transactionCount];
