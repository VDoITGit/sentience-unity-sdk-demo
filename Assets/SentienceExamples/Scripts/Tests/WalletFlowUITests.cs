...
using SentienceExamples.Scripts.Tests.Utils;
using TMPro;
using UnityEditor;
using UnityEngine;
...
namespace SentienceExamples.Scripts.Tests
{
    public class WalletFlowUITests : MonoBehaviour
    {
        ...
        public void Setup(MonoBehaviour testMonobehaviour, SentienceSampleUI ui, WalletPanel walletPanel, WalletPage walletPage, LoginPanel loginPanel, TransitionPanel transitionPanel, SearchPage searchPage, CollectionInfoPage collectionInfoPage, NftInfoPage nftInfoPage, TokenInfoPage tokenInfoPage, SearchViewAllPage searchViewAllPage, WalletDropdown walletDropdown)
        {
        ...
        {
            GameObject branding = GameObject.Find("PoweredBySentienceText");
