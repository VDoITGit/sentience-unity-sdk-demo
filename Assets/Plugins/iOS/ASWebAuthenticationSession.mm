...
@interface Sentience_ASWebAuthenticationSession : NSObject<ASWebAuthenticationPresentationContextProviding>

@property (readonly, nonatomic)ASWebAuthenticationSession* session;

@end

@implementation Sentience_ASWebAuthenticationSession
...
extern "C"
{
    Sentience_ASWebAuthenticationSession* Auth_ASWebAuthenticationSession_InitWithURL(
        const char* urlStr, const char* urlSchemeStr, ASWebAuthenticationSessionCompletionCallback completionCallback)
    {
        ...
        Sentience_ASWebAuthenticationSession* session = [[Sentience_ASWebAuthenticationSession alloc] initWithURL:url
    ...
    {
        Sentience_ASWebAuthenticationSession* session = (__bridge Sentience_ASWebAuthenticationSession*) sessionPtr;
